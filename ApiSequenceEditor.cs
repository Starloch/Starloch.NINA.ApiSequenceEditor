...
using Starloch.NINA.ApiSequenceEditor.Properties;
using System;
...
using Settings = Starloch.NINA.ApiSequenceEditor.Properties.Settings;
...
namespace Starloch.NINA.ApiSequenceEditor {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "ApiSequenceEditor_Options" where ApiSequenceEditor corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    ...
    public class ApiSequenceEditor : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "API Sequence Editor");

        [ImportingConstructor]
        public ApiSequenceEditor(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
