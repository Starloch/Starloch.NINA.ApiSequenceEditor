...
namespace Starloch.NINA.ApiSequenceEditor.ApiSequenceEditorTestCategory {
    ...
    public class ApiSequenceEditorCondition : SequenceCondition {
        /// <summary>
        ...
        public ApiSequenceEditorCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new ApiSequenceEditorCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ApiSequenceEditorCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}