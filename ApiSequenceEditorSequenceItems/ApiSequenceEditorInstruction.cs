...
namespace Starloch.NINA.ApiSequenceEditor.ApiSequenceEditorTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "API Sequence Editor")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class ApiSequenceEditorInstruction : SequenceItem {
        /// <summary>
        ...
        public ApiSequenceEditorInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public ApiSequenceEditorInstruction(ApiSequenceEditorInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new ApiSequenceEditorInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ApiSequenceEditorInstruction)}, Text: {Text}";
        }
    }
}