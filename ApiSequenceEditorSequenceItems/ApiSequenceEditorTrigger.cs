...
namespace Starloch.NINA.ApiSequenceEditor.ApiSequenceEditorTestCategory {
    ...
    public class ApiSequenceEditorTrigger : SequenceTrigger {
        /// <summary>
        ...
        public ApiSequenceEditorTrigger() {
        }

        public override object Clone() {
            return new ApiSequenceEditorTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ApiSequenceEditorTrigger)}";
        }
    }
}