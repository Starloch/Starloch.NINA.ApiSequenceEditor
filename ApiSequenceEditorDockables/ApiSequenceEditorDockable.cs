...
namespace Starloch.NINA.ApiSequenceEditor.ApiSequenceEditorDockables {
    /// <summary>
    ...
    public class ApiSequenceEditorDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public ApiSequenceEditorDockable(
            ...
            dict.Source = new Uri("Starloch.NINA.ApiSequenceEditor;component/ApiSequenceEditorDockables/ApiSequenceEditorDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Starloch.NINA.ApiSequenceEditor_AltitudeSVG"];
