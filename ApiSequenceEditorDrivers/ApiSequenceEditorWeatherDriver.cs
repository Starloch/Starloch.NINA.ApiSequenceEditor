...
namespace Starloch.NINA.ApiSequenceEditor.ApiSequenceEditorDrivers {
    ...
    /// </summary>
    public class ApiSequenceEditorWeatherDriver : BaseINPC, IWeatherData {
        public ApiSequenceEditorWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"ApiSequenceEditor Weather Data ({deviceId})";
        ...
        public string Category => "ApiSequenceEditor Weather Driver";
